...
#La relación entre código de plot y muestra ha de estar en la carpeta Codes en el excel Codes. En una hoja de cálculo con el mismo nombre de la fecha.
...
#Leemos el excel donde se encuentran los datos y formateamos las columnas para que puedan entrar en nuestro programa de regresión lineal.
...
#Separamos dia, mes, hora y minuto en columnas nombradas para que puedan ser usadas en la funcion de regresión lineal 
...
#Lo mismo pasa con el formato de la hora, a veces el EGM toma el dato como hh/mm/ss y en otras añade a la izquierda números que no entiendo (19 caracteres totales)
...
#Guardamos el archivo como un CSV para poder usarlo en la función. 
